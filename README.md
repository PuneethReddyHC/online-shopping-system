...
3>Download project from github(https://github.com/PuneethReddyHC/online-shopping-system-with-advanced-admin-page
.git).
...
7>select file [online-shopping-system-with-advanced-admin-page/database/onlineshop.sql].

8>edit file in folder online-shopping-system-advanced/db.php.

9>open any browser and type http://localhost/online-shopping-system-with-advanced-admin-page.
