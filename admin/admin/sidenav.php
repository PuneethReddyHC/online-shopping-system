...
<head>
    ...
    <!--     Fonts and icons--Phông chữ và biểu tượng     -->
...
<body class="dark-edition">
    <div class="wrapper ">
        ...
        Mẹo 1: Bạn có thể thay đổi màu của thanh bên bằng cách sử dụng: data-color="purple | azure | green | orange | Dangerous"

        Tip 2: you can also add an image using data-image tag -- : bạn cũng có thể thêm hình ảnh bằng thẻ data-image
    -->
            <div class="logo"><a href="index.php" class="simple-text logo-normal">
                    <!-- <img src="./assets/img/capture.png" style="width: 150px;"> -->
                    <img src="./assets/img/LogoCarHub.png" style="width: 150px;">
                </a></div>
